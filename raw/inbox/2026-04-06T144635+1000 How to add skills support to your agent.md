...
For each discovered `SKILL.md`, extract the metadata and body content. A `SKILL.md` file has two parts: YAML frontmatter between `---` delimiters, and a markdown body after the closing delimiter. To parse:
